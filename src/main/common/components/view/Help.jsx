  ...
  return (
    <div style={{width: '100%', height: '100%', display: 'flex', padding: '32px'}} className={'row no-margin'}>
      <div style={{marginRight: '4px', overflowY: 'hidden', height: '72px'}}
        ...
        <div className={'help-view-header view-header row w-100 no-margin'}>Armscor Connect {`v${packageJson.version}`}</div>
      </div>
              ...
              <ul className={'first-level-headings'}>
                <li>How do I create/schedule a new meeting?</li>
                  <ul className={'second-level-headings'}>
                    ...
                    <li>From the navigation bar, click on the Calendar tab <img src={require('../../assets/img/calendar-tab.png')} alt={''} style={{width: '64px'}}/></li>
                    <li>Click on the space on the desired date* and a new screen should appear <br/>  <img src={require('../../assets/img/calendar-date.png')} alt={''} style={{height: '128px', margin: '16px'}}/></li>
                    <li>Capture in all necessary meeting details (Subject , Time , Attendees , Location , Meeting description and submit by clicking the send button <br/><img src={require('../../assets/img/add-meeting.png')} alt={''} style={{height: '320px', margin: '16px'}}/></li>
                  </ul>
