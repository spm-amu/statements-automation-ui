            ...
            <>
                ...
                >
                    <div className='row' style={{width: '100%'}}>
                        ...
                        {" "}
                        <div className={"col-*-*"} style={{height: '64px', border: '2px solid red', width: '80px', float: 'right'}}>
                                        ...
                                        <UncontrolledDropdown nav>
                                            ...
                                            >
                                                <IconButton
                                                    ...
                                                    aria-haspopup="true"
                                                >
                                                    <img alt="..." src={this.state.avatar} width={'36px'} height={'36px'} style={{borderRadius:'50%'}}/>
                                                </IconButton>
                                                {" "}
